class SuperHero:
    ...
    def set_health(self, superhero_health: int) -> None:
        if superhero_health > 100:
            print("You can't set the health to more than 100")
        elif superhero_health < 0:
            print("You can't set the health to less than 0")
        else:
            self.__health = superhero_health

    def set_power_level(self, superhero_pl: int) -> None:
        if superhero_pl > 10:
            print("You can't set the power level to more than 10")
        elif superhero_pl < 1:
            print("You can't set the power level to less than 1")
        else:
            self.__power_level = superhero_pl
